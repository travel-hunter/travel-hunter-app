...
- Authenticated smoke routes include `/home`, `/policies`, `/policies/local-vacation`, `/trips`, `/trips/new`, `/trips/1`, `/ai-results?tripId=1`, `/friend-invite?tripId=1`, and `/mypage`.
